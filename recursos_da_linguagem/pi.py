...
"""
Módulo: pi.py
Objetivo: usar o valor matemático conhecido como pi, para cálculos
"""
...
def acesso():
    ...
    'isfinite', 'isinf', 'isnan', 'isqrt', 'ldexp', 'lgamma', 'log', 'log10', 'log1p', 'log2', 'modf', 'nan', 'perm',
