...
"""
Módulo: isinstance.py
Objetivo: retornar classe booleana do resultado se um objeto instanciado é herdeiro de uma classe específica
Observação:
    - esse método retorna True quando há herança entre classes, e retorna False quando não há
"""
...
if __name__ == '__main__':
    ...
    print([5], isinstance(objeto, Mensagem))  # classe Mensagem não passa qualquer herança para esse objeto
