...
verbs_infinitive = [
    ...
    'to change', 'to lead', 'to understand', 'to watch', 'to follow', 'to stop', 'to create', 'to speak', 'to read',
    'to allow', 'to add', 'to spend', 'to grow', 'to open', 'to walk', 'to win', 'to offer', 'to remember',
    'to love', 'to consider', 'to appear', 'to buy', 'to wait', 'to serve', 'to die', 'to send', 'to expect',
    'to build', 'to stay', 'to fall', 'to cut', 'to reach', 'to kill', 'to remain', 'to suggest', 'to raise',
    'to pass', 'to sell', 'to require', 'to report', 'to decide', 'to pull'
]

if __name__ == '__main__':
    print(len(verbs_infinitive))
