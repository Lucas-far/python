...
"""
Módulo: key.py
Objetivo: palavra reservada usada com o método sorted() para organizar dados dentro de um iterável

Observação:
    - método interage com outros iteráveis, convertendo-os para classe lista
    - método também usa outros métodos: min() e max() (necessário pesquisar)
    - método possui um segundo parâmetro, que inverte a ordem
"""
