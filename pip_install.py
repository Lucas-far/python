...
"""
Módulo: pip_install.py

Objetivo: registrar comandos pip que podem ser relevantes tanto para Python quanto em um projeto Python/Django
"""
...
def terminal():
    ...
    pip install PyMySQL
    pip install qrcode (/home/lucas/PycharmProjects/neural_nine/_qrcode.py)
